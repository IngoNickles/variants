...
-- Test Case: get_vector_product_2_dim
TEST.UNIT:vector
TEST.SUBPROGRAM:get_vector_product
TEST.NEW
TEST.NAME:get_vector_product_2_dim
TEST.VALUE:vector.get_vector_product.v1.x:1.0
TEST.VALUE:vector.get_vector_product.v1.y:2.0
TEST.VALUE:vector.get_vector_product.v2.x:2.0
TEST.VALUE:vector.get_vector_product.v2.y:1.0
TEST.EXPECTED:vector.get_vector_product.return:4.0
TEST.VARIANT_LOGIC_NAME:tc_2_dim
TEST.END

-- Test Case: get_vector_product_3_dim
TEST.UNIT:vector
TEST.SUBPROGRAM:get_vector_product
TEST.NEW
TEST.NAME:get_vector_product_3_dim
TEST.VALUE:vector.get_vector_product.v1.x:1.0
TEST.VALUE:vector.get_vector_product.v1.y:2.0
