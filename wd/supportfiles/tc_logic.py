...
def tc_2_dim(symbolic_constants_container):
    result = "THREE_DIMENSIONAL" not in symbolic_constants_container
    return result

def tc_3_dim(symbolic_constants_container):
    result = "THREE_DIMENSIONAL" in symbolic_constants_container
    return result